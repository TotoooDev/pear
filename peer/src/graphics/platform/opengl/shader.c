...
Shader* shader_new(const char* vertex_source, const char* fragment_source) {
    ...
    if (!success) {
        ...
        PEER_ERROR("failed to compile vertex shader! opengl error: %s", info_log);
    }
    ...
    if (!success) {
        ...
        PEER_ERROR("failed to compile fragment shader! opengl error: %s", info_log);
    }
    ...
    if (!success) {
        ...
        PEER_ERROR("failed to link shader! opengl error: %s", info_log);
    }
